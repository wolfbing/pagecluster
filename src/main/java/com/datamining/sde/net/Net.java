...
import com.datamining.cluster.nesttree.CollapseTree;
...
public class Net {
	...
	public static void copyTagNode(TagNode childOriginal, TagNode parentCopy)
	{
	...
	public static List<TagNode> copyTagNodes(List<TagNode> nodes)
	{
...
//			Net.traverseAndMatch(root, 0.8);
			new CollapseTree().traverseAndCollapse(root, 0.7);
			System.out.println("-------------------");
			ShowTagTree.printTreeByElement(new Formatter(System.out), root, " ");
		} catch (IOException e) {
